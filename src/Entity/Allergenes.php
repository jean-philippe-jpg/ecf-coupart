...
class Allergenes
{
    ...
    #[ORM\ManyToMany(targetEntity: User::class, inversedBy: 'allergene')]
    private Collection $users;

    #[ORM\ManyToMany(targetEntity: Recettes::class, mappedBy: 'allergenes')]
